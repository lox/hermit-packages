...
// shaka-project versions (7.x) - suffix hardcoded per version
version "7.1" {
  platform "linux" "amd64" {
    source = "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n${version}-2/ffmpeg-linux-x64"

    on "unpack" {
      rename {
        from = "${root}/ffmpeg-linux-x64"
        to = "${root}/ffmpeg"
      }
    }
  }
  ...
  platform "linux" "arm64" {
    source = "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n${version}-2/ffmpeg-linux-arm64"

    on "unpack" {
      rename {
        from = "${root}/ffmpeg-linux-arm64"
        to = "${root}/ffmpeg"
      }
    }
  }
  ...
  platform "darwin" "amd64" {
    source = "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n${version}-2/ffmpeg-osx-x64"

    on "unpack" {
      rename {
        from = "${root}/ffmpeg-osx-x64"
        to = "${root}/ffmpeg"
      }
    }
  }
  ...
  platform "darwin" "arm64" {
    source = "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n${version}-2/ffmpeg-osx-arm64"

    on "unpack" {
      rename {
        from = "${root}/ffmpeg-osx-arm64"
        to = "${root}/ffmpeg"
      }
    }
  }
...
// eugeneware versions (5.x) - different URL pattern
version "5.0" "5.0.1" {
  vars = {
    "arch_": "${arch}",
  }
...
sha256sums = {
  ...
  // shaka-project 7.1
  "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n7.1-2/ffmpeg-linux-arm64": "2f0f372203f3675b6cc25f176276aef49e17d66c5f0452d5d25cbaf2767e57f0",
  "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n7.1-2/ffmpeg-linux-x64": "c656811eecb083e3e0e8ee706a572fd919d275ba5ab34eb9f4762302afce4270",
  "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n7.1-2/ffmpeg-osx-arm64": "2888bb707bdc25d44e3eaf23c061db7549fc26995a5cbb359ad04465b6522f96",
  "https://github.com/shaka-project/static-ffmpeg-binaries/releases/download/n7.1-2/ffmpeg-osx-x64": "72bcfcd47dac126f9b0b025487785e53c9d8c0fda7a4cd49363641b52d40809b",
}
